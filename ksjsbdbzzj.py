    ...
    try:
        if json_arr['result'] == 1:
            ...
            if json_arr['result'] == 1:
                ...
                print("账号[" + name + "]" + "今日已分享，" + json_arr['error_msg'])
        else:
            print("账号[" + name + "]" + "分享任务失败:" + json_arr['error_msg'])
    except TypeError as reason:
